...
files = list.files(path='C:/Users/remil/OneDrive/Documents/GitHub/motor_gabor/data/MG2_data/final_csv', pattern = 'csv', recursive = F)
a = list()
...
save(data, file = 'C:/Users/remil/OneDrive/Documents/GitHub/motor_gabor/data/MG2_data/data_final_MG2.rda')
