...
transformed parameters {
  ...
  r_1_11 = r_1[, 11];
  r_1_12 = r_1[, 12];
  lprior += student_t_lpdf(Intercept | 3, 737.3, 220.7);
  lprior += student_t_lpdf(sigma | 3, 0, 220.7)
    - 1 * student_t_lccdf(0 | 3, 0, 220.7);
  lprior += gamma_lpdf(beta | 1, 0.1);
  lprior += student_t_lpdf(sd_1 | 3, 0, 220.7)
    - 12 * student_t_lccdf(0 | 3, 0, 220.7);
