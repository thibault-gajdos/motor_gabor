...
setwd('~/thib/projects/motor_gabor/data/AG_data/final_csv')

## * Prepare
# loop over files and append
files = list.files(path="~/thib/projects/motor_gabor/data/AG_data/final_csv/", pattern = 'csv', recursive = F)
a = list()
...
save(data, file = '~/thib/projects/motor_gabor/data/AG_data/data_final.rda')
