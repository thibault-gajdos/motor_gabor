...
transformed parameters {
  ...
  r_1_2 = (sd_1[2] * (z_1[2]));
  r_1_3 = (sd_1[3] * (z_1[3]));
  lprior += student_t_lpdf(Intercept | 3, 654.4, 177.2);
  lprior += student_t_lpdf(sigma | 3, 0, 177.2)
    - 1 * student_t_lccdf(0 | 3, 0, 177.2);
  lprior += gamma_lpdf(beta | 1, 0.1);
  lprior += student_t_lpdf(sd_1 | 3, 0, 177.2)
    - 3 * student_t_lccdf(0 | 3, 0, 177.2);
}
model {
