...
gabor$SDT[gabor$SDT == 'hit' & gabor$effector_order == 'same2'] = '6'
gabor$SDT[gabor$SDT == 'miss' & gabor$effector_order == 'same2'] = '7'
gabor$SDT[gabor$SDT == 'FA' & gabor$effector_order == 'same2'] = '8'
gabor$SDT[gabor$SDT == 'CR' & gabor$effector_order == 'same2'] = '9'

gabor$SDT[gabor$SDT == '6' & gabor$effector_order == 'same2'] = 'FA'
gabor$SDT[gabor$SDT == '7' & gabor$effector_order == 'same2'] = 'CR'
gabor$SDT[gabor$SDT == '8' & gabor$effector_order == 'same2'] = 'hit'
gabor$SDT[gabor$SDT == '9' & gabor$effector_order == 'same2'] = 'miss'
