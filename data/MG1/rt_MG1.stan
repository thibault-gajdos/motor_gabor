...
transformed parameters {
  ...
  lprior += student_t_lpdf(Intercept | 3, -0.3, 135.1);
  lprior += student_t_lpdf(sigma | 3, 0, 135.1)
    - 1 * student_t_lccdf(0 | 3, 0, 135.1);
  lprior += student_t_lpdf(sd_1 | 3, 0, 135.1)
    - 5 * student_t_lccdf(0 | 3, 0, 135.1);
}
model {
